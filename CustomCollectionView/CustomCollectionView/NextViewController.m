...
- (void)viewDidLoad {
    ...
    _backImageView.frame = CGRectMake(0, 0, SCREEN_WIDTH, 250*SCREEN_WIDTH/375);
    _imageView.frame = CGRectMake(0, 0, SCREEN_WIDTH, 250*SCREEN_WIDTH/375);
    _headerView.frame = CGRectMake(0, 0, SCREEN_WIDTH, 250*SCREEN_WIDTH/375);
